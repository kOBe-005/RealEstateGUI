...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email) {
        ...
        while(itr.hasNext()) {
            ...
            {
                dtm.addRow(new Object[]{userObj.getId(),userObj.getEmail(),userObj.getMobileNumber(),userObj.getAddress(),userObj.getSecurityQuestion(),userObj.getStatus()});
            }
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 180, 254, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Email", "Mobile Number", "Address", "Security Question", "Status"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 220, 1150, 460));

        jLabel4.setFont(new java.awt.Font("Microsoft YaHei Light", 0, 18)); // NOI18N
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/change Security Question.png"))); // NOI18N
        jLabel4.setText("Click on a row to change status");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 175, -1, -1));
        ...
        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/7.png"))); // NOI18N
