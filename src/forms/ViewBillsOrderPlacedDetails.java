...
public class ViewBillsOrderPlacedDetails extends javax.swing.JFrame {
    ...
    public void tableDetails(){
        ...
        System.out.println("Date: " + date + ", IncDec: " + incDec);
        
        ArrayList<Bill> list = null;
    if (incDec.equals("INC")) {
        list = BillDao.getAllRecordsbyInc(date);
    } else if (incDec.equals("DESC")) { // Added explicit check for DESC
        list = BillDao.getAllRecordsbyDesc(date);
    } else {
        System.out.println("Invalid IncDec value: " + incDec);
    }

    // Debug: check if list is null
    if (list == null) {
    ...
    for (Bill billObj : list) {
        System.out.println("Adding record: " + billObj); // Debug: print each billObj
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 180, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 180, 270, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 220, 1140, 451));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 175, -1, -1));
